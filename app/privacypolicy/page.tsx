        ...
        >
          <Card className="p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <p className="text-sm text-muted-foreground">This privacy policy page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" className="text-primary hover:underline">App Privacy Policy Generator</a></p>
            </div>
          </Card>
        </motion.div>
      </div>
