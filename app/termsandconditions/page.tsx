        ...
        >
          <Card className="p-8">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p>These terms and conditions apply to the Atlas Intelligence app (hereby referred to as "Application") for mobile devices that was created by Atlas Group (hereby referred to as "Service Provider") as a Freemium service.</p>
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><a href="https://policies.google.com/terms" className="text-primary hover:underline">Google Play Services</a></li>
                <li><a href="https://expo.io/terms" className="text-primary hover:underline">Expo</a></li>
              </ul>
              ...
              <p className="text-sm text-muted-foreground">This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" className="text-primary hover:underline">App Privacy Policy Generator</a></p>
            </div>
          </Card>
        </motion.div>
      </div>
